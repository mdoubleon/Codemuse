...
def _module_file_checks(root: Path) -> list[ReadinessCheck]:
    ...
    module_files = [
        ...
        "src/codemuse/api/rpc_mode.py",
        "src/codemuse/browser/session.py",
        "src/codemuse/learning/runtime.py",
        "src/codemuse/prompts/loader.py",
        "src/codemuse/session/session_config.py",
        "src/codemuse/tui/controller.py",
        ...
        "src/codemuse/web_tools/providers.py",
...
def _capability_checks(root: Path) -> list[ReadinessCheck]:
    ...
    required = {
        ...
        ("web_tool", "web_fetch"),
        ("web_tool", "web_search"),
        ("builtin_tool", "browser_navigate"),
        ("builtin_tool", "browser_state"),
        ("mcp_tool", "mcp_status"),
        ("skill", "run_skill"),
